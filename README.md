...
Перейдите в каталог проекта, создайие и активируйте виртуальное окружение:
...
- Не используйте проект как production CA без отдельного аудита, аппаратной или внешней защиты ключей, процедур резервного копирования и регламентов эксплуатации.
